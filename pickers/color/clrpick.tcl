...
proc ::tk::dialog::color:: {args} {
    ...
    set data(BARS_WIDTH) [expr $data(NUM_COLORBARS)*15] ;#160
...
proc ::tk::dialog::color::BuildDialog {w} {
  ...
  upvar ::tk::dialog::color::[winfo name $w] data
    ...
    set ent [ttk::entry $selFrame.ent -textvariable $mainentry -width 16]
    set f1  [ttk::frame $selFrame.f1 -relief sunken]
    set data(finalCanvas) [frame $f1.demo -bd 1 -width 116 -height 116]
    ...
    ttk::button $botFrame.ok     -text [mc "OK"]		\
	    -command [list tk::dialog::color::OkCmd $w] -width 8
    ttk::button $botFrame.cancel -text [mc "Cancel"]	\
	    -command [list tk::dialog::color::CancelCmd $w] -width 8
